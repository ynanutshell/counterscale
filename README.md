...
A reskinned version of [@benvinegar/counterscale](https://github.com/benvinegar/counterscale) to better match my personal site's colors.

![](/packages/server/public/reskinned-counterscale.webp)
